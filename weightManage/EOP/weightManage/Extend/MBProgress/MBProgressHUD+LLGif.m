...
static UIImageView *webGifWebView;
static MBProgressHUD *utilHUD;

@implementation MBProgressHUD (LLGif)
...
//        webGifImageView.clipsToBounds = YES;
        webGifImageView.backgroundColor = [UIColor clearColor];
        webGifImageView.image = [self getImageBySize:CGSizeMake(LOAD_W, LOAD_H)];
        
        webGifWebView = [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, LOAD_W, LOAD_H)];
        webGifWebView.backgroundColor = [UIColor clearColor];
        webGifWebView.contentMode = UIViewContentModeScaleAspectFit;
        [webGifImageView addSubview:webGifWebView];
        
//        webGifWebView = [[WKWebView alloc] initWithFrame:CGRectMake(0, 0, LOAD_W, LOAD_H)];
//        webGifWebView.backgroundColor = [UIColor clearColor];
//        webGifWebView.scrollView.backgroundColor = [UIColor clearColor];
//        webGifWebView.opaque = false;
//        [webGifImageView addSubview:webGifWebView];
    }
...
//    NSString *gifUrl = [[NSBundle mainBundle]pathForResource:GIF_IMAGE_NAME ofType:@"gif"];
//    [webGifWebView loadRequest:[NSURLRequest requestWithURL:[NSURL fileURLWithPath:gifUrl]]];
//    webGifWebView.scrollView.backgroundColor = [UIColor clearColor];

    webGifWebView.image = [UIImage sd_animatedGIFNamed:GIF_IMAGE_NAME];
    ...
    utilHUD.backgroundColor = [UIColor clearColor];
    ...
    utilHUD.bezelView.style = MBProgressHUDBackgroundStyleSolidColor;
    utilHUD.bezelView.color = [UIColor colorWithWhite:0.f alpha:0.f];
